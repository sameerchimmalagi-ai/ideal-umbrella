...
activities = {
    ...
    "Art Club": {
        ...
        "max_participants": 25,
        "participants": ["isabella@mergington.edu", "sophia.l@mergington.edu"]
    },
    "Choir": {
    ...
    "Robotics Club": {
        ...
        "max_participants": 15,
        "participants": ["ethan@mergington.edu", "ava.s@mergington.edu"]
    },
    "Debate Team": {
        "description": "Develop public speaking and argumentation skills",
        "schedule": "Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["sophia.k@mergington.edu", "lucas@mergington.edu"]
    }
}
...
def unregister_from_activity(activity_name: str, email: str):
    """Unregister a student (remove their email from the activity participants list)"""
    # Validate activity exists
    if activity_name not in activities:
        raise HTTPException(status_code=404, detail="Activity not found")
